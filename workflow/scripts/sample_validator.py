...
class SampleValidator:
    ...
    def __init__(self, config_path: Path, criteria: Optional[ValidationCriteria] = None):
    ...
    def _check_metadata_completeness(self, accession: str) -> float:
        ...
        try:
            ...
            self.logger.debug(f"Found {valid_values} valid fields out of {len(required_fields)} required")
            return score
    ...
    async def validate_sample(self, accession: str) -> ValidationResult:
        ...
        try:
            ...
            passes_all = (metadata_score >= self.criteria.min_metadata_completeness and valid_values > 0)
    ...
    async def _check_metadata_completeness(self, accession: str) -> tuple[float, int]:
        ...
        valid_values = sum(1 for field in required_fields 
