...
## Resource Requirements and Cost Estimates (KEEP IN MIND: these are estimates generated by copilot: these estimates can change based on the computer brand and how long one has been using them for)
